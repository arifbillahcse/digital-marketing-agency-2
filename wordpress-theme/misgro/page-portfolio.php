 ...
 * Description: Portfolio page — converted from portfolio.html.
 *
 * Loads automatically for the WordPress page with slug "portfolio".
 *
 * NOTE: portfolio.html in the original site uses a different (alternate) footer
 * markup — `<footer>` with `.ft`/`.fb`/`.fcol`. We render that footer inline here
 * to preserve the exact look, then call wp_footer() and the closing tags by hand.
 * This keeps the standard footer.php (used by every other page) untouched.
 */
get_header();
?>
...
<section class="hero">
  ...
  <div class="h-in wrap">
    <div class="hero-text">
      <div class="bc"><a href="<?php echo esc_url( misgro_page_url( 'home' ) ); ?>">Home</a><i class="fas fa-chevron-right"></i><span style="color:#fff">Portfolio</span></div>
...
<div class="results-band">
  <div class="rb-inner">
    <div class="rb-head rv">
      ...
      <p class="sub" style="margin:14px auto 0">Aggregated across all client engagements — these are the outcomes that define what MISGRO delivers at scale.</p>
    </div>
    <div class="rb-grid">
  ...
  <div class="tspot-inner">
    ...
    <div class="tspot-grid">
      <div class="tsc rv">
        ...
        <p class="tsc-text">We had been investing in SEO for two years with another agency and seen almost no movement. MISGRO audited us, identified the core issues in the first week, and within nine months we were ranking for terms we had never ranked for. The pipeline impact was transformational.</p>
      ...
      <div class="tsc rv">
        ...
        <div class="tsc-q">"</div>
        <div class="tsc-stars"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i></div>
        <p class="tsc-text">I was spending $1K a month and getting maybe one or two sales. MISGRO completely restructured my campaigns, and by month three we were at $20K a month in budget delivering a 7.8x return. I genuinely did not think numbers like that were achievable for a brand our size.</p>
      ...
      <div class="tsc rv">
        ...
        <div class="tsc-q">"</div>
        <div class="tsc-stars"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i></div>
        <p class="tsc-text">Our email list was sitting there doing nothing for years. MISGRO turned it into a revenue engine in 90 days. 35% of our total monthly revenue now comes from email automations they built. I cannot overstate how much this changed our business model and our margins.</p>
  ...
  <div class="cta-in rv">
    <div class="cta-c">
      ...
      <div class="cta-btns">
        ...
        <a href="<?php echo esc_url( misgro_page_url( 'services' ) ); ?>" class="btn-g"><i class="fas fa-table-cells-large"></i> Explore Our Services</a>
      </div>
    </div>
  </div>
</section>

<!-- ═══ FOOTER (alternate styling used by portfolio.html) ═══ -->
<footer>
  <div class="ft wrap">
    <div class="fb">
    ...
    <div class="fcol">
      <h4>Services</h4>
      <div class="flinks">
        <a href="<?php echo esc_url( misgro_page_url( 'services' ) ); ?>"><i class="fas fa-magnifying-glass-chart"></i> SEO Optimization</a>
        <a href="<?php echo esc_url( misgro_page_url( 'services' ) ); ?>"><i class="fab fa-google"></i> Google Ads</a>
        <a href="<?php echo esc_url( misgro_page_url( 'services' ) ); ?>"><i class="fab fa-meta"></i> Facebook &amp; Instagram Ads</a>
        <a href="<?php echo esc_url( misgro_page_url( 'services' ) ); ?>"><i class="fas fa-hashtag"></i> Social Media</a>
        <a href="<?php echo esc_url( misgro_page_url( 'services' ) ); ?>"><i class="fas fa-pen-nib"></i> Content Marketing</a>
        <a href="<?php echo esc_url( misgro_page_url( 'services' ) ); ?>"><i class="fas fa-envelope-open-text"></i> Email Marketing</a>
        <a href="<?php echo esc_url( misgro_page_url( 'services' ) ); ?>"><i class="fas fa-chart-line"></i> CRO</a>
        <a href="<?php echo esc_url( misgro_page_url( 'services' ) ); ?>"><i class="fas fa-chart-pie"></i> Analytics</a>
      </div>
    </div>
    <div class="fcol">
      <h4>Company</h4>
      <div class="flinks">
        <a href="<?php echo esc_url( misgro_page_url( 'about' ) ); ?>"><i class="fas fa-building"></i> About Us</a>
        <a href="<?php echo esc_url( misgro_page_url( 'about' ) ); ?>#team"><i class="fas fa-users"></i> Our Team</a>
        <a href="<?php echo esc_url( misgro_page_url( 'why-choose-us' ) ); ?>"><i class="fas fa-star"></i> Why Choose Us</a>
        <a href="<?php echo esc_url( misgro_page_url( 'portfolio' ) ); ?>"><i class="fas fa-award"></i> Portfolio</a>
      </div>
    </div>
    <div class="fcol">
      <h4>Contact</h4>
...
<?php
// Page uses an alternate footer markup (rendered above), so we close the
// document manually here instead of calling get_footer().
wp_footer();
?>
</body>
</html>
