 ...
 * Description: Contact page — converted from contact.html.
 *
 * Loads automatically for the WordPress page with slug "contact".
 */
get_header();
?>
...
<section class="hero">
  ...
  <div class="h-in wrap">
    <!-- Left: text -->
    <div class="hero-text">
      <div class="bc"><a href="<?php echo esc_url( misgro_page_url( 'home' ) ); ?>">Home</a><i class="fas fa-chevron-right"></i><span style="color:#fff">Contact</span></div>
    ...
    <div class="hv">
      ...
      <div class="hv-block hvb">
        ...
        <img src="https://images.unsplash.com/photo-1553877522-43269d4ea984?w=700&h=1000&q=90&auto=format&fit=crop&crop=center" alt="MISGRO office team" loading="eager"/>
        <div class="hv-ov"></div>
      </div>
...
<div class="faq">
  <div class="faq-inner">
    ...
    <div class="faq-list rv">
      ...
      <div class="faq-item">
        <div class="faq-q" onclick="toggleFaq(this)">
          What is the minimum budget to work with MISGRO?
          <div class="faq-ico"><i class="fas fa-plus"></i></div>
        </div>
...
<section class="cta">
  <div class="cta-in rv">
    <div class="cta-c">
      ...
      <p class="cta-d">150+ businesses have trusted MISGRO with their growth. Browse our case studies and client testimonials before reaching out — we think you will like what you see.</p>
      <div class="cta-btns">
        <a href="<?php echo esc_url( misgro_page_url( 'portfolio' ) ); ?>" class="btn btn-p">View Case Studies <i class="fas fa-arrow-right"></i></a>
        <a href="<?php echo esc_url( misgro_page_url( 'about' ) ); ?>" class="btn-g"><i class="fas fa-users"></i> Meet the Team</a>
      </div>
    </div>
  </div>
</section>
